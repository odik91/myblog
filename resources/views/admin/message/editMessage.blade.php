              ...
              <div class="card-body">
                <div class="form-group to">
                  ...
                  @for ($i = 0; $i < sizeof($receivers); $i++)
                    <button name="del" class="btn btn-sm btn-outline-dark receiver{{ $i }}" onclick='removeTo(".receiver{{ $i }}");'>{{ $receivers[$i] }} <i class="far fa-window-close"></i></button>
                    <input type="hidden" name="receivers[]" value="{{ $receivers[$i] }}" class="receiver{{ $receivers[$i] }}">
                  @endfor
                  </span>
                  @error('receivers')
                ...
                <div class="form-group">
                  <input class="form-control @error('subject') is-invalid @enderror" placeholder="Subject:" name="subject" value="{{ $messages['subject'] }}" required>
                ...
                <div class="form-group">
                  <textarea id="compose-textarea" class="form-control @error('message') is-invalid @enderror" style="height: 300px" name="message" required>{!! $messages['message'] !!}</textarea>
