      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route('role.create') }}" class="btn btn-info btn-sm float-right"><i class="fas fa-plus pr-1"></i>Add new role</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Are you sure want to delete <b>{{ ucfirst($role['name']) }}</b> ?
                          </div>
